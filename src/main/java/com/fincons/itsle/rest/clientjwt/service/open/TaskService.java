...
public class TaskService {
    ...
    public void taskOne(){
        ...
        log.info("Utenti sul DB: {}", userService.findAll().size());
        //50 utenti
    }
    ...
    public void taskTwo(){
        ...
        var myId = userService.createUser(myUser).getId();
        log.info("My id: {}", myId);

        User myRetrievedUser = userService.findOneById(myId);
    ...
    public void taskThree(){
        ...
        List<User> usersNotDomainCom = userService.findAll().stream().toList();
        //50 utenti
        ...
        editedUsers.forEach(
              u ->  {
                  var user = userService.updateUser(u);
    ...
    public void taskFour(){
        ...
        List<User> allUsers = userService.findAll().stream().toList();
